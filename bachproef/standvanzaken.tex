...
Deze literatuurstudie schetst de huidige stand van z\section{Cyber Resilience Act}
...
CPE (Common Platform Enumeration) strings identificeren gestandaardiseerd vendor, product en versie van getroffen software, volgens het gestandaardiseerde patroon van NIST \autocite{CPE_23}:
\begin{verbatim}
...
Voor deze bachelorproef is gekozen voor de combinatie \textbf{Syft (SBOM), OWASP Dependency-Check (SCA)} en \textbf{SonarQube (SAST)}, omwille van:
\begin{itemize}
